...
void testReservations(Library& lib){
    ...
    cout<<endl <<"Reserving "<<rooms[0]<<" for "<<students[0]<<" on "<<endl;
    d1.print();
    ...
    cout<<endl<<"Reserving "<<rooms[1]<<" for "<<students[2]<<" on "<<endl;
    d2.print();
    ...
    cout<<endl<<"Reserving "<<rooms[0]<<" for "<<students[3]<<" on "<<endl;
    d4.print();
